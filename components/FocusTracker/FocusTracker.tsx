...
export function FocusTracker() {
  ...
  return (
    <>
      ...
      <div
        ref={focusTrackerEl}
        className="pointer-events-none absolute z-50 border-2 border-current opacity-0 outline outline-2 outline-offset-2 outline-current transition-all duration-200"
      ></div>
    </>
  )
}
